    ...
    <footer className="bg-black text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          {/* Company Info */}
          <div>
            <h3 className="text-2xl font-serif mb-4">Luxury Interiors</h3>
            <p className="text-gray-400 mb-4">
              Transforming spaces into luxurious, functional works of art.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/services/space-planning" className="text-gray-400 hover:text-white transition-colors">
                  Space Planning
                </Link>
              </li>
              <li>
                <Link href="/services/custom-furniture" className="text-gray-400 hover:text-white transition-colors">
                  Custom Furniture
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>info@luxuryinteriors.com</li>
            </ul>
          </div>
        </div>

        <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Luxury Interiors. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
